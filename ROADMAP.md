...
- **Advanced Powerups**: Magnet, Gravity Well, Ball Splitter, Freeze, Pierce - all with unique visuals
...
## Future - Long-term
- **Online Features**: Global leaderboards, cloud sync, challenge events
- **Controller Support**: Gamepad controls for TV mode
- **Advanced Difficulty**: Speed presets, size options, high contrast mode
